Feature: Login into Salesforce web application
  ...
  Scenario: LoginErrorMessage
    ...
    And User enters value into text box username as "yasmin@tekarch.com"
  ...
  Scenario: LogintoSalesfore
    ...
    When user on "LoginPage"
    And User enters value into text box username as "yasmin@tekarch.com"
    And User enters value into text box password as "TGByhn@123"
    And Click on Login button
  ...
  Scenario: Remember me
    ...
    And user on "homepage"
    Then verify we can see "Home" page
    When User clicks on Yasmin Yassin tab
    And User clicks Logout button
    And user on "LoginPage"
    Then verify we can see "Username" populated with the username yasminsuleyman55@gmail.com
  ...
  Scenario: Forgot Password A
    ...
    And User enters value into text box username as "yasmin@tekarch.com" on forgot password page
