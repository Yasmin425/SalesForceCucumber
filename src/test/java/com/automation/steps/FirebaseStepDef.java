...
public class FirebaseStepDef {
	...
	public void user_clicks_on_yasmin_yassin_tab() {
		home.SelectYasminYassinTab();
	}
	...
	@Then("verify we can see {string} populated with the username yasminsuleyman55@gmail.com")
